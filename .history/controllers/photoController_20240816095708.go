...
func AddPhoto(c *gin.Context) {
	...
	var body struct {
		...
		Uploaded_     uint    `json:"uploaded_by" binding:"required"` //Uploaded by
	}
...
func UpdatePhoto(c *gin.Context) {
	...
	var photo models.Photo
	result := initializers.DB.First(&photo, id)
	...
	if contentForUpdate.User_id != 0 {
		photo.User_id = contentForUpdate.User_id
	}
