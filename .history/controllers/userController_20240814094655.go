...
func CreateAccount(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"userln" : body.first_name,
		"userp" : body.first_name,
		"userg" : body.first_name,
		"userbd" : body.first_name,
		"userad" : body.first_name,
		"userem" : body.first_name,
		"usermob" : body.first_name,
	})
