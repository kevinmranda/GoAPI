...
func Routes() {
	...
	r.DELETE("/deleteUser/:id", controllers.DeletePhoto)
	r.GET("/getUser/:id", controllers.GetPhoto)
	r.GET("/getUsers/", controllers.GetPhotos)
	r.PUT("/updateUser/:id", controllers.UpdatePhoto)
