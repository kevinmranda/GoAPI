...
func Routes() {
	...
	r.DELETE("/removeOrder/:id", controllers.DeletePayment)
	r.GET("/getOrder/:id", controllers.GetPayment)
	r.GET("/getOrders/", controllers.GetPayments)
	r.PUT("/updateOrder/:id", controllers.UpdatePayment)
