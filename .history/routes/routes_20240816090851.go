...
func Routes() {
	...
	//Order Routes
	r.POST("/addOrder", controllers.AddPhoto)
	r.DELETE("/removeOrder/:id", controllers.DeletePhoto)
	r.GET("/getOrder/:id", controllers.GetPhoto)
	r.GET("/getOrders/", controllers.GetPhotos)
	r.PUT("/update/:id", controllers.UpdatePhoto)
